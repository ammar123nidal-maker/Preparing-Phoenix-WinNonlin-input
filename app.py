...
# تحويل الأعمدة إلى datetime
    df['Schedule Time'] = pd.to_datetime(df['Schedule Time'], format='%H:%M:%S').dt.time
    df['Actual Time'] = pd.to_datetime(df['Actual Time'], format='%H:%M:%S').dt.time
